...
//
//import uet.oop.bomberman.OldCode.AbstractCharacter.Move;
...
//    return
//        ((pixelCoord + BombermanComponent.getSquareSize() - 1) / BombermanComponent.getSquareSize())
//            - 1;
//  }
//
...
//      if (collidingCircles(player, squareToPixel(tup.getColIndex()),
...
//      powerupList.add(
//          new BombRadiusPU(squareToPixel(rowIndex) + BombermanComponent.getSquareMiddle(),
//              squareToPixel(colIndex) + BombermanComponent.getSquareMiddle()));
//    } else if (r > CHANCE_FOR_COUNTER_POWERUP) {
//      powerupList.add(
//          new BombCounter(squareToPixel(rowIndex) + BombermanComponent.getSquareMiddle(),
//              squareToPixel(colIndex) + BombermanComponent.getSquareMiddle()));
//    }
//  }
//
...
//        if ((randRowIndex % 2) == 0) {
//          enemyList.add(
//              new Enemy(squareToPixel(randColIndex) + BombermanComponent.getSquareMiddle(),
