...
public class BombermanComponent extends JComponent implements FloorListener {
  ...
  protected void paintComponent(Graphics g) {
    ...
    for (AbstractPowerup p : floor.getPowerupList()) {
      ...
      } else if (p.getName().equals("BombRange")) {
    ...
    for (Bomb b : floor.getBombList()) {
      ...
      g2d.fillOval(bombX + BOMB_ADJUSTMENT_1, bombY + BOMB_ADJUSTMENT_1, Bomb.getBOMBSIZE(),
          Bomb.getBOMBSIZE());
      g2d.setColor(Color.ORANGE);
      g2d.fillOval(bombX + BOMB_ADJUSTMENT_2, bombY + BOMB_ADJUSTMENT_1, BOMB_ADJUSTMENT_1,
          BOMB_ADJUSTMENT_2);
    }
  ...
  private void paintUnbreakableBlock(int rowIndex, int colIndex, Graphics g2d) {
    ...
    g2d.drawLine(colIndex * SQUARE_SIZE, rowIndex * SQUARE_SIZE + SQUARE_SIZE,
        colIndex * SQUARE_SIZE + SQUARE_SIZE, rowIndex * SQUARE_SIZE + SQUARE_SIZE);
    g2d.drawLine(colIndex * SQUARE_SIZE, rowIndex * SQUARE_SIZE, colIndex * SQUARE_SIZE,
        rowIndex * SQUARE_SIZE + SQUARE_SIZE);
    g2d.drawLine(colIndex * SQUARE_SIZE + SQUARE_SIZE, rowIndex * SQUARE_SIZE,
        colIndex * SQUARE_SIZE + SQUARE_SIZE, rowIndex * SQUARE_SIZE + SQUARE_SIZE);
  }
